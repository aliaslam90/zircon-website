    ...
    <section className="relative min-h-[600px] md:h-[700px] w-full bg-black overflow-hidden flex items-center justify-center pt-24 pb-12 md:pt-20 md:pb-0">
      ...
      <div className="absolute inset-0 z-0 flex items-center justify-center overflow-hidden">
        <div className="relative w-full h-full flex items-center justify-center">
          {/* Centered video with matching radial glow size */}
          <div className="relative w-[200px] h-[200px] md:w-[320px] md:h-[320px] lg:w-[380px] lg:h-[380px] rounded-full overflow-hidden">
            {/* Enhanced Radial Mask Overlay – matches video circle */}
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,rgba(0,0,0,0.2)_55%,rgba(0,0,0,0.9)_100%)] pointer-events-none" />
            {/* Subtle blue accent glow – same circle size */}
